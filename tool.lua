...
-- NÚT UP: (0.1, -65, 0.1, -25)
-- NÚT DOWN: (0.1, -15, 0.1, -25)
-- ==========================================
...
local function forceSaveToFile(items)
    ...
    local success, err = pcall(function()
        writefile(FILE_NAME, table.concat(items, "\n"))
    end)
    if success then
...
upBtnOut.Position = UDim2.new(0.1, -65, 0.1, -25)
...
downBtnOut.Position = UDim2.new(0.1, -15, 0.1, -25)
...
print("========================================")
print("📍 Vị trí nút UP: (0.1, -65, 0.1, -25)")
print("📍 Vị trí nút DOWN: (0.1, -15, 0.1, -25)")
